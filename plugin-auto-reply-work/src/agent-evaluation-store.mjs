...
const ACTIONS = new Set(['respond', 'ask_for_image', 'ask_for_city', 'ask_for_missing_information', 'start_quote', 'recognize_image', 'resolve_showtime', 'quote_realtime', 'request_price_change', 'create_manual_task', 'show_available_wplus_seats', 'record_seat_preference', 'confirm_quote', 'get_order_status', 'read_linked_order', 'inspect_ticket_request', 'handoff', 'wait']);
