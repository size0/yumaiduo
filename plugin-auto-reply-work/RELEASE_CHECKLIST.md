...
> 当前生产已部署源码候选 `7910d62aff4b7428ef83031d556b0fc53e04000f`：V3契约为 `wanda-v3-v11-pricing-account-evidence`，插件Runtime为 `wanda-agent-runtime-v30-semantic-context-city-gate`。自然语言由AI语义抽取、交易事实仍由确定性引擎验证；生产继续保持Shadow、确定性执行Owner和Active 0%。
...
- [x] 当前源码插件测试 488 项、V3 后端测试 189 项通过；V3 测试无弃用警告
...
- [x] 生产已移除未启用的外部Dify advisory Provider；V30使用内部主Agent语义抽取与确定性交易引擎
...
- [x] 已在源码提交 `7910d62` 使用干净依赖执行插件488项测试和V3 189项测试；生产release再次执行插件488项测试通过
...
- [x] 已为源码提交 `7910d62aff4b7428ef83031d556b0fc53e04000f` 生成并验证确定性V3和插件候选包及独立SHA-256；本地候选目录为 `dist/release-candidates/7910d62aff4b`
...
- [ ] V30重新采集至少100轮自动安全审计和100轮图片样本；V29及更旧版本样本不得补门槛
- [x] 已完成V30到V29回滚及V30恢复演练；两端健康、WorkingDirectory和队列恢复通过
...
- V3 SHA-256：`a277fb09e9acb793679379ebcf31d84f70b1f0bbb1773197027d69d855c7e5c6`
- 插件 SHA-256：`44ce37a8da81588953bf8b8a8cf9e90985cc929eff92230cf69f23e55b8bd6b4`
- Manifest SHA-256：`f50ebce4a1675917fde463892cb9919def94a64be1bc32e9066ef64618b6734a`
- 构建命令：`python deploy/build_release_bundles.py`
- 校验命令：`python deploy/verify_release_bundles.py dist/release-candidates/7910d62aff4b`
- 生产V3：`/opt/wanda-v3-backend/releases/v11-pricing-account-evidence-7910d62aff4b`
- 生产插件：`/opt/wanda-preview-plugin/releases/v30-semantic-context-7910d62aff4b`
