...
> 当前生产V3来自 `b92d6d5ba8129c1a9173afcee797dbfb44ffd3a4`，插件release来自 `b5911b9852d4a6924ac03e19d7d0c2728b5e4d79`：V3契约为 `wanda-v3-v13-shadow-evaluation-switch`，插件Runtime为 `wanda-agent-runtime-v33-shadow-evaluation-switch`。因生产审计发现圈选误判和混合座位类型核价缺口，自动报价已紧急关闭；确定性待付款改价保持开启，防止已确认报价订单漏改。自由生成AI回复保持关闭，独立只读Shadow评测继续积累事件时点样本。
...
- [x] 已在源码提交 `b5911b9` 使用干净依赖执行插件513项测试；生产release再次执行插件513项测试通过；V3 207项保持通过
...
- [x] 已为源码提交 `b5911b9852d4a6924ac03e19d7d0c2728b5e4d79` 生成并验证确定性V3和插件候选包及独立SHA-256；本地候选目录为 `dist/release-candidates/b5911b9852d4`
...
- 插件 SHA-256：`6c279e3feaf863cad196fe99d209b580d60541d06fecb90a450cca6b23bc6d68`
- Manifest SHA-256：`6bee2a5d1fe442f5b3b33fe3e2f10a9bc12123980d35a2f0bde49da46dc1a339`
- 构建命令：`python deploy/build_release_bundles.py`
- 校验命令：`python deploy/verify_release_bundles.py dist/release-candidates/b5911b9852d4`
- 生产V3：`/opt/wanda-v3-backend/releases/v13-shadow-switch-b92d6d5ba812`
- 生产插件：`/opt/wanda-preview-plugin/releases/v33-workbench-redesign-b5911b9852d4`
