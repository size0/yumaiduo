...
> 当前生产已部署源码候选 `b23846b95ac10960f7b573bd3e911a9c9143c5d7`：V3契约为 `wanda-v3-v11-pricing-account-evidence`，插件Runtime仍为 `wanda-agent-runtime-v31-release-fence-cleanup`。本次拆分V3报价领域与诊断模块，不改变价格公式、临时试价或Agent工具行为；生产继续保持Shadow、确定性执行Owner和Active 0%。
...
- [x] 当前源码插件测试 491 项、V3 后端测试 197 项通过；新增V3领域与诊断测试覆盖实时座位解析、逐座权威校验、确定性试价、价格边界及脱敏失败结构
...
- [x] 已在源码提交 `b23846b` 使用干净依赖执行插件491项测试和V3 197项测试；生产release再次执行插件491项测试通过
...
- [x] 已为源码提交 `b23846b95ac10960f7b573bd3e911a9c9143c5d7` 生成并验证确定性V3和插件候选包及独立SHA-256；本地候选目录为 `dist/release-candidates/b23846b95ac1`
...
- [x] 已完成V3报价领域拆分release到前一V31 release回滚及恢复演练；两端健康、WorkingDirectory和队列恢复通过
...
- V3 SHA-256：`8a08aeeb0c6aec175173705aa14ec71060fd65e55a02f731a2adf9c26f25ec24`
- 插件 SHA-256：`796aa1c77967ff36a78b6490bba517828da521fb710cb179849d4f3ae14a5a2d`
- Manifest SHA-256：`902b2fe3e6ab0264b1956712f9cef89d89217e434e2a9189971af9bb7e067828`
- 构建命令：`python deploy/build_release_bundles.py`
- 校验命令：`python deploy/verify_release_bundles.py dist/release-candidates/b23846b95ac1`
- 生产V3：`/opt/wanda-v3-backend/releases/v11-quote-domain-b23846b95ac1`
- 生产插件：`/opt/wanda-preview-plugin/releases/v31-quote-domain-b23846b95ac1`
