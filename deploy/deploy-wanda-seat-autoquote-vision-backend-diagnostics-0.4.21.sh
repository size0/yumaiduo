...
release=/opt/wanda-preview-plugin/releases/wanda-plugin-0.4.21-vision-backend-diagnostics-20260817
package=/tmp/wanda-seat-autoquote-0.4.21-vision-backend-diagnostics-20260817.tgz
dropin=/tmp/wanda-seat-autoquote-vision-backend-diagnostics-0.4.21.service.conf
...
install -D -m 0644 "$dropin" \
  /etc/systemd/system/wanda-seat-autoquote.service.d/zzzzzzzzzzzzzz-vision-backend-diagnostics-0.4.21.conf
