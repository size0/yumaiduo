...
class Settings(BaseModel):
    ...
    quote_record_ttl_seconds: int = Field(default=30 * 60, ge=60, le=24 * 60 * 60)
    ...
    xianyu_reprice_enabled: bool = False
    wanda_provider_writes_enabled: bool = False
    refund_enabled: bool = False
    ship_enabled: bool = False
    # Active Probe is independent of the conversation layer and remains
    # disabled by default.
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            quote_record_ttl_seconds=int(os.getenv("WANDA_QUOTE_RECORD_TTL_SECONDS", str(30 * 60))),
            ...
            message_send_enabled=_env_flag("MESSAGE_SEND_ENABLED"),
            xianyu_reprice_enabled=_env_flag("XIANYU_REPRICE_ENABLED"),
            wanda_provider_writes_enabled=_env_flag("WANDA_PROVIDER_WRITES_ENABLED"),
            refund_enabled=_env_flag("REFUND_ENABLED"),
